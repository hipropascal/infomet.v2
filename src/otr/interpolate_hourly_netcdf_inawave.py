...
def get_slice_inawave():
    nc = Dataset('/Users/maritim/Project/BMKG/infomet_nelayan/data/raw_netcdf/inawave.nc', 'r')
    time = nc['time'][:]
    lat = nc['lat'][:]
    lon = nc['lon'][:]
    hs = nc['hs'][:]
    ...
    vwnd = nc['vwnd'][:]
    # Prepare container
    new_nc = Dataset('/Users/maritim/Project/BMKG/infomet_nelayan/data/raw_netcdf/1h.nc', 'w')
